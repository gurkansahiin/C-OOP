...
namespace NesneProje
{
    ...
    //İnterface
    public class Uyeİslemleri:IUye,IDigerİslemler
    {
        ...
        public void UyelerMetodu(SqlConnection baglanti, DataGridView dataGridView, string tabloAdi)
        {
            ...
            SqlDataAdapter sda = new SqlDataAdapter(query, baglanti);//SqlDataAdapter, bir veritabanı bağlantısı üzerinden bir SqlCommand nesnesi
                                                                     //ile belirtilen SQL sorgularını çalıştırarak veritabanından veri çeker
                                                                     //bu veriyi bir DataTable veya DataSet nesnesine doldurur.
            SqlCommandBuilder builder = new SqlCommandBuilder(sda);
            var ds = new DataSet();
            sda.Fill(ds);//veritabanı verilerini bir DataSet veya DataTable nesnesine doldurur.
       ...
       // Bu metodun amacı, UyeTbl tablosundan UAdSoyad alanındaki üye isimlerini çekip, bu isimleri bir ComboBox içerisine doldurmaktır.
